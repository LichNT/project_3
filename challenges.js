...
var requireUserCountWithinTime = function(userCount, timeLimit) {// thong bao can co tren moi trang khoi dong
    return {
        description: "",
...
var challenges = [
    ...
    ,{options: {floorCount: 11, elevatorCount: 5, spawnRate: 1.1}, condition: requireUserCountWithMaxWaitTime(60, 190)}
